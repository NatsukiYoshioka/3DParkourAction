...
private:
	...
	static constexpr float fixPosY = 25.0f;				//カメラY座標調整量
	static constexpr float fixFoewardPos = 25.0f;		//カメラ前押し出し量
	...
	static constexpr float cameraNear = 5.0f;			//カメラの手前描画範囲
	static constexpr float cameraFar = 1500.0f;			//カメラの奥描画距離
};
